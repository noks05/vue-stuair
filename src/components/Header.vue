...
import activeBurger from "../assets/js/burger.js";
  ...
  <header class="header">
    <div class="head container">
      ...
      <nav class="nav">
        ...
        <RouterLink class="head__sign" to="/sign">
...
.header {
  ...
  background-image: url("../../src/assets/img/bg-main.jpg");
